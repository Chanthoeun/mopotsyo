...
return [
    ...
    'label' => [
        ...
        'pending_approval_request' => 'Pending :model Approval for :name',
    ],
    ...
    'body' => [
        ...
        'rejected' => 'Your :request for :days of :leave_type :dates was rejected by :name.',
        'discarded' => 'Your :request for :days of :leave_type :dates was discarded by :name.',
        'completed_leave_request' => 'Your :request for :days of :leave_type :dates was approved and completed by :name.',
        ...
        'completed_overtime' => 'Your overtime request for :amount on :date was approved and completed by :name.',
        'rejected_overtime' => 'Your overtime request for :amount on :date was rejected by :name.',
        'discarded_overtime' => 'Your overtime request for :amount on :date was discarded by :name.',
        ...
        'completed_switch_working_day' => 'Your switch working day request from :from to :to was approved and completed by :name.',
        'rejected_switch_working_day' => 'Your switch working day request from :from to :to was rejected by :name.',
        'discarded_switch_working_day' => 'Your switch working day request from :from to :to was discarded by :name.',
        ...
        'completed_work_from_home' => 'Your work from home request for :days from :from to :to was approved and completed by :name.',
        'rejected_work_from_home' => 'Your work from home request for :days from :from to :to was rejected by :name.',
        'discarded_work_from_home' => 'Your work from home request for :days from :from to :to was discarded by :name.',
        ...
        'purchase_request_completed' => 'Your purchase request number :number was checked and approved by :actionedBy. Procurement team continue to work on your request.',
        'purchase_request_rejected' => 'Your purchase request number :number was rejected by :actionedBy.',
        'purchase_request_discarded' => 'Your purchase request number :number was discarded by :actionedBy.',
        'purchase_request_discarded_by_owner' => ':name just :action a purchase request number :number.',
        'pending_approval' => 'A new :model request from :name is pending your approval.',
        'generic_approved' => 'Your :model request (:name) has been approved.',
        'generic_rejected' => 'Your :model request (:name) has been rejected.',
        'generic_discarded' => 'Your :model request (:name) has been discarded.',
        'missing_approver_role' => 'Missing configured approvers for the following role(s): :roles.',
        'discarded_notice' => ':name has discarded their :model request.',
        'no_approver_configured' => 'You do not have a supervisor or any approver configured in your contract. Please contact HR to set up your approval path.',
    ]
];
