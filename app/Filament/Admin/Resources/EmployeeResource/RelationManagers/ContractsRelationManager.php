...
class ContractsRelationManager extends RelationManager
{
                        ...
                        ->schema([
                            ...
                            Forms\Components\Select::make('supervisor_id')
                                ...
                                ->afterStateUpdated(function ($state, Get $get, Set $set) {
                                    $this->updateApprovers($state, $get('department_head_id'), $set, $get);
                                }),
                            Forms\Components\Select::make('department_head_id')
                                ...
                                ->live()
                                ->afterStateUpdated(function ($state, Get $get, Set $set) {
                                    $this->updateApprovers($get('supervisor_id'), $state, $set, $get);
                                }),
    ...
    {
        if ($departmentHeadId && $supervisorId) {
            $set('approvers', []);
            $approver = User::find($supervisorId);
            $state = $departmentHeadId; // Mapping for legacy code compatibility

            if ($supervisorId == $departmentHeadId) {
                ...
                $set("approvers.5.approver_id", $supervisorId);
                ...
                $set("approvers.8.approver_id", $supervisorId);
